...
consolidate_data= BashOperator(
    ...
    bash_command="""
    DATE=$(date +%Y-%m-%d)
    paste -d "," /opt/airflow/data/csv_data-$DATE.csv /opt/airflow/data/tsv_data-$DATE.csv /opt/airflow/data/fixed_width_data-$DATE.csv > /opt/airflow/data/extracted_data-$DATE.csv""",
    dag=dag,
)
